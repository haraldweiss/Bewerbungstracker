...
def _build_user_prompt(
    ...
    lines = [
        ...
        "  sie WORTWOERTLICH aus den vorgelegten Mails. Bei LinkedIn sind",
        "  das typisch 'Jobangebot ansehen', 'View job' oder 'Show job'.",
        "  Achte GENAU auf die letzte Textzeile VOR der LinkedIn-URL.",
