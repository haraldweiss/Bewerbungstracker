...
def _build_user_prompt(
    ...
    lines = [
        ...
        "  sie WORTWOERTLICH aus den vorgelegten Mails (z.B. den klickbaren",
        "  Link-Text wie '<LABEL_VOR_JOB_URL_AUS_MAIL>'). Erfinde KEINE Werte",
        "  und uebernimm KEINE Beispiele — nimm exakt die letzte Textzeile VOR",
        "  der Job-URL in der jeweiligen Card.",
...
def ai_learn_pattern(user, train_samples: list[dict], platform: str,
    ...
    es sei denn provider_override/model_override sind gesetzt.
